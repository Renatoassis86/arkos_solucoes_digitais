...
// Formulário customizado da Kairós — só é montado depois que o pai (page.tsx)
// já validou o PIN contra kairos_briefing_pins. Recebe o pin só pra anexar
// no envio; toda a lógica de "código válido?"/"já respondeu?" fica no pai,
// que decide QUAL formulário customizado montar (hoje só existe o da
